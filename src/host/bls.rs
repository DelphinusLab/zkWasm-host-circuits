...
use halo2_proofs::pairing::bls12_381::{Fq as Bls381Fq, G1Affine, G2Affine, Gt as Bls381Gt};
...
#[cfg(test)]
mod tests {
    use crate::host::bls::{create_bls_pair_shared_table, create_bls_sum_shared_table};
